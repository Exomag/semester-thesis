function [solData, solYALMIP, objective, samples, k_active] = solveProblemScenario(params)
    % Parameters
    Ts = params.Ts;
    c_x = params.c_x;
    c_y = params.c_y;
    ...
    for k = 1:N
        ...
        objective = objective + norm(Q*x_var{k + 1}, 2) + norm(R*u_var{k}, 2);
        ...
        constraints = [constraints, x1_var_curr >= y1(k + 1) + c_x - M * t_var_curr(2) + samples{k}];
