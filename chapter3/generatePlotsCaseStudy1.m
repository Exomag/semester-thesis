function generatePlotsCaseStudy1()
    ...
    save2tikz('plots/jointCC_costs_boxplot')
    ...
    set(gca, 'TickLabelInterpreter', 'latex')
    save2tikz('plots/jointCC_viols_boxplot')
    ...
    legend('hide')
    set(gca, 'TickLabelInterpreter', 'latex')
    save2tikz('plots/jointCC_times_boxplot')
    ...
    set(gca, 'TickLabelInterpreter', 'latex')
    save2tikz('plots/jointCC_SA_nonmoving')
    ...
    save2tikz('plots/jointCC_SA_moving')
    ...
    legend({'ego car', 'adversary car', 'maximum uncertainty'}, 'Location', 'northwest', 'interpreter', 'latex')
    set(gca, 'TickLabelInterpreter', 'latex')
    save2tikz('plots/jointCC_MRA_nonmoving')
    ...
    save2tikz('plots/jointCC_MRA_moving')
end
